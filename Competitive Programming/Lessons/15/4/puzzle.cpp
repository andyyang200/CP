...
/*
You have an array A of size K and a grid of length N. You want to color each square of the grid either 
black or white such that there are exactly K blocks of consecutive black squares, and the ith block from the left
has length Ai. Your job is to find out more information about possible solutions.
The grid is given as a string. Some squares of the grid are initially already colored in, and these squares
cannot be changed. "X" denotes a black, "_" denotes white, and "?" denotes and uncolored square.
k
For each square in the grid, print:
"X" if this square is black in all solutions
"_" if this square is white in all solutions
"?" otherwise
