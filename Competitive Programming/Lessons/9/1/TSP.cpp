...
Given a graph of N nodes (1 <= N <= 15), find the shortest way to visit all nodes. You can start and end anywhere.
*/
...
int main(void)
{
	...
	for (int mask = 0; mask < (1 << n); mask++) // initialize dp array
	{
		for (int i = 0; i < n; i++)
		{
			dp[mask][i] = INF;
